...
//        self.analogClockView.setSecHandImage(UIImage(named: "rSecondHand.png")?.CGImage)
        ...
        self.analogClockView.setMinHandImage(UIImage(named: "min.png")?.CGImage)
        self.analogClockView.setSecHandImage(UIImage(named: "sec.png")?.CGImage)
    }
...
//                self.arcView0.removeFromSuperview()
            ...
            case 0:
                ...
                self.arcView0 = CircleGraphView(frame: CGRect(x: 50, y: 50, width: self.analogClockView.frame.width-100, height: self.analogClockView.frame.height-100))
            ...
            case 1:
                ...
                self.arcView1 = CircleGraphView(frame: CGRect(x: 50, y: 50, width: self.analogClockView.frame.width-100, height: self.analogClockView.frame.height-100))
            ...
            case 2:
                ...
                self.arcView2 = CircleGraphView(frame: CGRect(x: 50, y: 50, width: self.analogClockView.frame.width-100, height: self.analogClockView.frame.height-100))
            ...
            case 3:
                ...
                self.arcView3 = CircleGraphView(frame: CGRect(x: 50, y: 50, width: self.analogClockView.frame.width-100, height: self.analogClockView.frame.height-100))
            ...
            case 4:
                ...
                self.arcView4 = CircleGraphView(frame: CGRect(x: 50, y: 50, width: self.analogClockView.frame.width-100, height: self.analogClockView.frame.height-100))
