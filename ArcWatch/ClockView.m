...
#define HOURS_HAND_LENGTH 0.3
#define MIN_HAND_LENGTH 0.52
#define SEC_HAND_LENGTH 0.62
//in pixels
#define HOURS_HAND_WIDTH 6
#define MIN_HAND_WIDTH 6
#define SEC_HAND_WIDTH 6
...
//		h = CGImageGetHeight((__bridge CGImageRef)secHand.contents)/scale;
	...
	hourHand.anchorPoint = CGPointMake(0.5,0.07);
	minHand.anchorPoint = CGPointMake(0.5,0.047);
	secHand.anchorPoint = CGPointMake(0.5,0.129);
